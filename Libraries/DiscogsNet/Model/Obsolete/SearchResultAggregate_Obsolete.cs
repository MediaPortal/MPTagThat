...
{
    public class SearchResultAggregate_Obsolete
    {
        private SearchResult_Obsolete searchResult;
        ...
        public SearchResultAggregate_Obsolete(SearchResult_Obsolete searchResult)
        {
