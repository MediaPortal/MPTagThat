namespace OAuth
{
    ...
    public class Manager
    {
        ...
        public Dictionary<string,string> ReturnTokens()
        {
            Dictionary<string, string> tokens = new Dictionary<string, string>();
            tokens["token"] = _params["token"];
            tokens["token_secret"] = _params["token_secret"];
            return tokens;
        }
        /// <summary>
        ...
        /// </returns>
        public OAuthResponse AcquireRequestToken(string uri, string method, string user_agent)
        {
            NewRequest();
            ...
            //var useragent = _params["user_agent"];
        ...
        ///   poauth_token=foo&something_else=bar.
        /// </returns>
        public OAuthResponse AcquireAccessToken(string uri, string method, string pin, string user_agent)
        {
            NewRequest();
