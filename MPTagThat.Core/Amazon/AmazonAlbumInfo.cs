...
namespace MPTagThat.Core.Amazon
{
  public class AmazonAlbumInfo : IDisposable
  {
    ...
    private const string itemLookup = "&Operation=ItemLookup&ItemId={0}&ResponseGroup=Images,ItemAttributes";
    private const string itemSearch = "&Operation=ItemSearch&Artist={0}&Title={1}&SearchIndex=Music&ResponseGroup=Images,ItemAttributes";
    #endregion
