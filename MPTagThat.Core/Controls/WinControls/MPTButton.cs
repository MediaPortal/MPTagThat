  ...
  public class MPTButton : System.Windows.Forms.Button
  {
    ...
    private void OnMessageReceive(QueueMessage message)
    {
      ...
      switch (action.ToLower())
      {
        ...
        case "themechanged":
          {
            this.BackColor = themeManager.CurrentTheme.ButtonBackColor;
            this.ForeColor = themeManager.CurrentTheme.ButtonForeColor;
            this.Font = themeManager.CurrentTheme.ButtonFont;
            break;
          }
