...
namespace MPTagThat.Core.ShellLib
{
  ...
  public interface IShellFolder
  {
    ...
    Int32 ParseDisplayName(
      ...
      [MarshalAs(UnmanagedType.LPWStr)] String pszDisplayName, // Null-terminated UNICODE string with the display name.
    ...
    // Address of a single ULONG value that, on entry, contains the attributes that 
